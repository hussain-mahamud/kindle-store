...
<div class="col-md-12 col-sm-12 content-head">
   <div class="addbook-div float-right">
      <a href="#" type="button" class="btn btn-primary" data-toggle="modal" data-target=".bd-example-modal-lg">Add Book</a>
   </div>
</div>
<!-- modal -->
      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
            <form class="form-horizontal form-label-left" method="POST" enctype="multipart/form-data">
               ...
               <div class="form-group row ">
                  <label class="control-label col-md-3 col-sm-3 ">Sub Title*</label>
                  <div class="col-md-9 col-sm-9 ">
               ...
               <div class="form-group row ">
                  ...
                  <div class="col-md-9 col-sm-9 ">
                     <input type="text" class="form-control"  name="book_keywords"> 
                  </div>
               </div>
               <div class="form-group row ">
                  <label class="control-label col-md-3 col-sm-3 ">Co Author</label>
                  <div class="col-md-9 col-sm-9 ">
               ...
               <div class="form-group row ">
                  <label class="control-label col-md-3 col-sm-3 ">Book</label>
                  <div class="col-md-9 col-sm-9 ">
                     <input type="file" class="form-control"  name="book_file"> 
                  </div>
               </div>
               <div class="form-group row">
               	<label class="col-md-3 col-sm-3  control-label">Feature Book
               	</label>

               	<div class="col-md-9 col-sm-9 ">
               		<div class="radio">
               			<input type="radio" name="feature" value="0" checked="checked"><b>&nbsp;&nbsp;Not</b>
               			<input type="radio" name="feature" value="1"><b>&nbsp;&nbsp;Yes</b>
               		</div>
         ...
         <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary">Upload Book</button>
         </div>
      </div>
   </div>
</div>
