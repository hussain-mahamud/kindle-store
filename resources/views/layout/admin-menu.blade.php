 <div id="sidebar-menu" class="main_menu_side hidden-print main_menu" >
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-book"></i> Book Management <span class="fa fa-chevron-down"></span></a>
                  ...
                  <li><a><i class="fa fa-user"></i> User Management <span class="fa fa-chevron-down"></span></a>
                   ...
                   <li><a><i class="fa fa-user"></i> Category Management <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                  ...
                  <li><a><i class="fa fa-user"></i> Slider Management <span class="fa fa-chevron-down"></span></a>
                   ...
                   <li><a><i class="fa fa-user"></i> Purchase Management <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                  ...
                  <li><a><i class="fa fa-user"></i>Report Generation <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
